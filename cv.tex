...
\begin{itemize}
    ...
    This research relies heavily on work by  Fink, G. Giansiracusa, N. Giansiracusa, Rinc\'on, Speyer, and Sturmfels.
\end{itemize}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\resheading{Talks Given}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%         \textit{UGA Department of Mathematics}
    ...
    \item \textbf{Logistic Organizer} \hfill Fall 2014 -- Spring 2015 \\
          \textit{Student Algebraic Geometry Seminar}
\end{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{itemize}
    \item \textbf{University of Georgia:} Elliptic Curves, Varieties, Schemes, Algebraic Curves, Sheaves and Cohomology, Flag Varieties, Lie Algebras, Toric Varieties, Complex Multiplication, Central Simple Algebras, Schubert Calculus VRG, Tropical Geometry VRG.
    \item \textbf{University of Massachusetts:} Algebra I \& II, Real Analysis I \& II, Complex Analysis, Topology, Manifolds I \& II, Asymptotic Problems, Algebraic Number Theory, Theory of Computation.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Mathematical Programming:} Sage, Pari/GP, and Magma, R.

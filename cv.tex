...
\item \ressubheading{University of Georgia}{Athens, Georgia}{Mathematics, Ph.D Candidate.}{2014 -- 2019}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\resheading{Preprints and Publications}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{itemize}
\item \textbf{On the Finite Generation of Relative Cohomology for Lie Superalgebras} \\
  Accepted for publication in \emph{Proceedings of the American Mathematical Society}. \\ \null \hfill \emph{\href{https://arxiv.org/abs/1711.02112}{https://arxiv.org/abs/1711.02112}} \hfill 
\end{itemize}
...
\begin{itemize}
\item \textbf{Title TBD} \hfill Spring 2019 \\
  AMS Sectional (Special Session): Recent Advances in Lie and Related Algebras and their Representations
\item \textbf{Title TBD} \hfill Fall 2018 \\
  Texas A\&M  Algebra Seminar
\item \textbf{On the Finite Generation of Cohomology for Lie Superalgebras} \hfill Spring 2018 \\
  AMS Sectional (Special Session): Hopf Algebras, Tensor Categories, and Homological Algebra
 \item \textbf{On the Finite Generation of Cohomology for Lie Superalgebras} \hfill Fall 2017 \\
   AMS Sectional (Special Session): Categorical Methods in Representation Theory
...
\begin{itemize}
    ...
    \item \textbf{Special Session on Hopf Algebras, Tensor Categories, and Homological Algebra} \\
          \textit{Northeastern University}\hfill Spring 2018
...
\item \textbf{Co-Organizer} \hfill 2018 \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{itemize}
\item \textbf{Math 1113:} Precalculus (two sections) \hfill Fall 2018 \\
